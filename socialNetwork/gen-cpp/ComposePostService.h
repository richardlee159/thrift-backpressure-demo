...
class ComposePostServiceIf {
 public:
  ...
  virtual void ComposePost(const int64_t req_id, const std::string& text) = 0;
};
...
class ComposePostServiceNull : virtual public ComposePostServiceIf {
 public:
  ...
  void ComposePost(const int64_t /* req_id */, const std::string& /* text */) {
    return;
  }
};

typedef struct _ComposePostService_ComposePost_args__isset {
  _ComposePostService_ComposePost_args__isset() : req_id(false), text(false) {}
  bool req_id :1;
  bool text :1;
...
class ComposePostService_ComposePost_args {
 public:
  ...
  ComposePostService_ComposePost_args() : req_id(0), text() {
  }
...
class ComposePostServiceClient : virtual public ComposePostServiceIf {
 ...
 public:
  ...
  void ComposePost(const int64_t req_id, const std::string& text);
  void send_ComposePost(const int64_t req_id, const std::string& text);
...
class ComposePostServiceMultiface : virtual public ComposePostServiceIf {
 ...
 public:
  void ComposePost(const int64_t req_id, const std::string& text) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->ComposePost(req_id, text);
    }
    ifaces_[i]->ComposePost(req_id, text);
  }
...
class ComposePostServiceConcurrentClient : virtual public ComposePostServiceIf {
 ...
 public:
  ...
  void ComposePost(const int64_t req_id, const std::string& text);
  int32_t send_ComposePost(const int64_t req_id, const std::string& text);
