...
void TextServiceClient::ComposeText(std::string& _return, const int64_t req_id, const std::string& text)
{
...
void TextServiceClient::recv_ComposeText(std::string& _return)
{
...
void TextServiceConcurrentClient::ComposeText(std::string& _return, const int64_t req_id, const std::string& text)
{
...
void TextServiceConcurrentClient::recv_ComposeText(std::string& _return, const int32_t seqid)
{
