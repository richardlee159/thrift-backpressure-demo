...
class TextServiceIf {
 public:
  ...
  virtual void ComposeText(std::string& _return, const int64_t req_id, const std::string& text) = 0;
};
...
class TextServiceNull : virtual public TextServiceIf {
 public:
  ...
  void ComposeText(std::string& /* _return */, const int64_t /* req_id */, const std::string& /* text */) {
    return;
  }
};
...
class TextService_ComposeText_result {
 public:
  ...
  TextService_ComposeText_result() : success() {
  }
...
class TextServiceClient : virtual public TextServiceIf {
 ...
 public:
  ...
  void recv_ComposeText(std::string& _return);
 protected:
...
class TextServiceConcurrentClient : virtual public TextServiceIf {
 ...
 public:
  ...
  void recv_ComposeText(std::string& _return, const int32_t seqid);
 protected:
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
